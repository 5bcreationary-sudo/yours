    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-6">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-semibold tracking-tight text-primary-app">Welcome back</h1>
          <p className="text-sm text-muted-foreground mt-1">Log in to hear your morning briefing</p>
        </div>
        ...
        <button
          ...
          className="w-full rounded-xl border border-border bg-card px-4 py-3 text-sm font-medium text-primary-app hover:bg-accent transition-colors flex items-center justify-center gap-2"
        >
        ...
        <p className="text-center text-xs text-muted-foreground mt-6">
          ...
          <Link to="/signup" className="text-[hsl(var(--blue-accent))] hover:underline font-medium">Sign up free</Link>
        </p>
      </motion.div>
    </div>
  );
